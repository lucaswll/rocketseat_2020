...
interface Data {  //pra fazer a interface, uso como auxiliar o Insomnia
  point: {
    image: string;
    name: string;
    email: string;
...
const Detail = () => {
  ...
  const routeParams = route.params as Params//ponto selecionado
  ...
  function handleWhatsapp(){
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Teste buscando nº wpp pela API.`)
  }
